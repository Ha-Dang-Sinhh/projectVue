            ...
            <div class="mt-5 w-full">
              <div class="w-full border-t-2 border-gray-100 font-medium text-gray-600 py-4 px-4 w-full block hover:bg-gray-100 transition duration-150">
                <img src="https://pantazisoft.com/img/avatar-2.jpeg" alt="" class="rounded-full h-6 shadow-md inline-block mr-2">
                  Edit Email
                <input class=" pl-3 py-1 rounded border border-yellow-500" type="text" v-model="editEmail">
              </div>

              <div class="w-full border-t-2 border-gray-100 font-medium text-gray-600 py-4 px-4 w-full block hover:bg-gray-100 transition duration-150">
                <img src="https://pantazisoft.com/img/avatar-2.jpeg" alt="" class="rounded-full h-6 shadow-md inline-block mr-2">
                  Edit Name
                <input class=" pl-3 py-1 rounded border border-yellow-500" type="text" v-model="editName">
              </div>

              <div class="w-full border-t-2 border-gray-100 font-medium text-gray-600 py-4 px-4 w-full block hover:bg-gray-100 transition duration-150">
                <img src="https://pantazisoft.com/img/avatar-2.jpeg" alt="" class="rounded-full h-6 shadow-md inline-block mr-2">
                  Edit Phone
                <input class=" pl-3 py-1 rounded border border-yellow-500" type="text" v-model="editPhone">
              </div>
...
export default {
  ...
  methods: {
    ...
    async updateProfile(){
      try{
        const respEditProfile = await authService.updateUser({
